...
<link href="js/B-JUI.1.31/B-JUI/themes/css/bootstrap.min.css" rel="stylesheet">
<style type="text/css">
...
function choose_bg() {
    ...
    $('body').css('background-image', 'url(js/B-JUI.1.31/images/loginbg_0'+ bg +'.jpg)');
}
</script>
</head>
<body>
...
<div class="container">
    <div class="main_box">
        <form action="LoginServlet?method=login" id="login_form" method="post">
            ...
            <div class="text-center">
                <hr>
                2014 - 2016 <a href="jsp/index/index.jsp">档案管理</a>
            </div>
        </form>
    </div>
</div>
