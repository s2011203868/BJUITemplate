...
<title>js/B-JUI.1.31/B-JUI 前端管理框架</title>
...
<!-- bootstrap - css -->
<link href="js/B-JUI.1.31/B-JUI/themes/css/bootstrap.css" rel="stylesheet">
<!-- core - css -->
<link href="js/B-JUI.1.31/B-JUI/themes/css/style.css" rel="stylesheet">
<link href="js/B-JUI.1.31/B-JUI/themes/blue/core.css" id="bjui-link-theme" rel="stylesheet">
<link href="js/B-JUI.1.31/B-JUI/themes/css/fontsize.css" id="bjui-link-theme" rel="stylesheet">
<!-- plug - css -->
<link href="js/B-JUI.1.31/B-JUI/plugins/kindeditor_4.1.11/themes/default/default.css" rel="stylesheet">
<link href="js/B-JUI.1.31/B-JUI/plugins/colorpicker/css/bootstrap-colorpicker.min.css" rel="stylesheet">
<link href="js/B-JUI.1.31/B-JUI/plugins/nice-validator-1.0.7/jquery.validator.css" rel="stylesheet">
<link href="js/B-JUI.1.31/B-JUI/plugins/bootstrapSelect/bootstrap-select.css" rel="stylesheet">
<link href="js/B-JUI.1.31/B-JUI/plugins/webuploader/webuploader.css" rel="stylesheet">
<link href="js/B-JUI.1.31/B-JUI/themes/css/FA/css/font-awesome.min.css" rel="stylesheet">
<!-- Favicons -->
<link rel="apple-touch-icon-precomposed" href="assets/ico/apple-touch-icon-precomposed.png">
<link rel="shortcut icon" href="assets/ico/favicon.png">
<!--[if lte IE 7]>
<link href="js/B-JUI.1.31/B-JUI/themes/css/ie7.css" rel="stylesheet">
<![endif]-->
<!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
<!--[if lte IE 9]>
    <script src="js/B-JUI.1.31/B-JUI/other/html5shiv.min.js"></script>
    <script src="js/B-JUI.1.31/B-JUI/other/respond.min.js"></script>
<![endif]-->
<!-- jquery -->
<script src="js/B-JUI.1.31/B-JUI/js/jquery-1.11.3.min.js"></script>
<script src="js/B-JUI.1.31/B-JUI/js/jquery.cookie.js"></script>
<!--[if lte IE 9]>
<script src="js/B-JUI.1.31/B-JUI/other/jquery.iframe-transport.js"></script>
<![endif]-->
<!-- js/B-JUI.1.31/B-JUI -->
<script src="js/B-JUI.1.31/B-JUI/js/bjui-all.min.js"></script>
<!-- plugins -->
<!-- swfupload for kindeditor -->
<script src="js/B-JUI.1.31/B-JUI/plugins/swfupload/swfupload.js"></script>
<!-- Webuploader -->
<script src="js/B-JUI.1.31/B-JUI/plugins/webuploader/webuploader.js"></script>
<!-- kindeditor -->
<script src="js/B-JUI.1.31/B-JUI/plugins/kindeditor_4.1.11/kindeditor-all-min.js"></script>
<script src="js/B-JUI.1.31/B-JUI/plugins/kindeditor_4.1.11/lang/zh-CN.js"></script>
<!-- colorpicker -->
<script src="js/B-JUI.1.31/B-JUI/plugins/colorpicker/js/bootstrap-colorpicker.min.js"></script>
<!-- ztree -->
<script src="js/B-JUI.1.31/B-JUI/plugins/ztree/jquery.ztree.all-3.5.js"></script>
<!-- nice validate -->
<script src="js/B-JUI.1.31/B-JUI/plugins/nice-validator-1.0.7/jquery.validator.js"></script>
<script src="js/B-JUI.1.31/B-JUI/plugins/nice-validator-1.0.7/jquery.validator.themes.js"></script>
<!-- bootstrap plugins -->
<script src="js/B-JUI.1.31/B-JUI/plugins/bootstrap.min.js"></script>
<script src="js/B-JUI.1.31/B-JUI/plugins/bootstrapSelect/bootstrap-select.min.js"></script>
<script src="js/B-JUI.1.31/B-JUI/plugins/bootstrapSelect/defaults-zh_CN.min.js"></script>
<!-- icheck -->
<script src="js/B-JUI.1.31/B-JUI/plugins/icheck/icheck.min.js"></script>
<!-- HighCharts -->
<script src="js/B-JUI.1.31/B-JUI/plugins/highcharts/highcharts.js"></script>
<script src="js/B-JUI.1.31/B-JUI/plugins/highcharts/highcharts-3d.js"></script>
<script src="js/B-JUI.1.31/B-JUI/plugins/highcharts/themes/gray.js"></script>
<!-- other plugins -->
<script src="js/B-JUI.1.31/B-JUI/plugins/other/jquery.autosize.js"></script>
<link href="js/B-JUI.1.31/B-JUI/plugins/uploadify/css/uploadify.css" rel="stylesheet">
<script src="js/B-JUI.1.31/B-JUI/plugins/uploadify/scripts/jquery.uploadify.min.js"></script>
<script src="js/B-JUI.1.31/B-JUI/plugins/download/jquery.fileDownload.js"></script>
<!-- init -->
    ...
    <header class="navbar bjui-header" id="bjui-navbar">
        <div class="container_fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="http://b-jui.com"><img src="js/B-JUI.1.31/images/logo.png" height="30"></a>
            </div>
            <nav class="collapse navbar-collapse" id="bjui-navbar-collapse">
                <ul class="nav navbar-nav navbar-right" id="bjui-hnav-navbar">
                    <li class="active">
                        <a href="js/B-JUI.1.31/json/menu-form.json" data-toggle="sidenav" data-id-key="targetid">表单相关</a>
                    </li>
                    <li>
                        <a href="js/B-JUI.1.31/json/menu-base.json" data-toggle="sidenav" data-id-key="targetid">基础组件</a>
                    </li>
                    <li>
